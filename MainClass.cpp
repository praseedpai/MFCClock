...
public:
    ...
    void OnPaint()
    {
        ...
        int xs = (int)(120 * cos((-fsec * PI / 180.0) + PI / 2.0));
        int ys = (int) (120 * sin((-fsec * PI / 180.0) + PI / 2.0));

        int xm =(int) ( 100 * cos((-fmin * PI / 180.0) + PI / 2.0));
        int ym =(int) ( 100 * sin((-fmin * PI / 180.0) + PI / 2.0));


        int xh = (int)(60 * cos((-fhour * PI / 180.0) + PI / 2.0));
        int yh = (int)(60 * sin((-fhour * PI / 180.0) + PI / 2.0));
        ...
        for (int i = 0; i < 12; i++)
        {
            int x =(int) ( 200 * cos(i * PI / 6));
            int y = (int) ( 200 * sin(i * PI / 6));
            Transform(&x, &y);
